...
export type QuickViewConfigQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type QuickViewConfigQuery = {
  metaobjects: {
    nodes: Array<{
      fields: Array<
...
export type MetaobjectWithImagesQueryVariables = StorefrontAPI.Exact<{
  id: StorefrontAPI.Scalars['ID']['input'];
}>;

export type MetaobjectWithImagesQuery = {
...
export type MediaImageQueryVariables = StorefrontAPI.Exact<{
  id: StorefrontAPI.Scalars['ID']['input'];
}>;

export type MediaImageQuery = {
  mediaImage?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query QuickViewConfig($country: CountryCode, $language: LanguageCode) \n    @inContext(country: $country, language: $language) {\n    metaobjects(type: "quick_view_config", first: 1) {\n      nodes {\n        fields {\n          key\n          value\n          type\n        }\n      }\n    }\n  }\n': {
    return: QuickViewConfigQuery;
    variables: QuickViewConfigQueryVariables;
  };
  ...
  '#graphql\n        query MetaobjectWithImages($id: ID!) {\n          metaobject(id: $id) {\n            id\n            type\n            fields {\n              key\n              value\n              type\n            }\n          }\n        }\n      ': {
    return: MetaobjectWithImagesQuery;
    variables: MetaobjectWithImagesQueryVariables;
  };
  '#graphql\n                  query MediaImage($id: ID!) {\n                    mediaImage: node(id: $id) {\n                      ... on MediaImage {\n                        id\n                        image {\n                          url\n                          altText\n                          width\n                          height\n                        }\n                      }\n                    }\n                  }\n                ': {
    return: MediaImageQuery;
    variables: MediaImageQueryVariables;
  };
